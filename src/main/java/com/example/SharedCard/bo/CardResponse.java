...
public class CardResponse {
    ...
    public CardResponse(CardEntity card) {
        ...
        this.totalSpent = ((List)transactions).stream()
                .filter(t -> "APPROVED".equals(((com.example.SharedCard.entities.TransactionEntity)t).getStatus()))
                .mapToDouble(t -> ((com.example.SharedCard.entities.TransactionEntity)t).getAmount())
                .sum();
        ...
        this.dailySpent = ((List)transactions).stream()
                .filter(t -> "APPROVED".equals(((com.example.SharedCard.entities.TransactionEntity)t).getStatus()))
                .filter(t -> ((com.example.SharedCard.entities.TransactionEntity)t).getCreatedAt().isAfter(now.minusDays(1)))
                .mapToDouble(t -> ((com.example.SharedCard.entities.TransactionEntity)t).getAmount())
                .sum();

        this.weeklySpent = ((List)transactions).stream()
                .filter(t -> "APPROVED".equals(((com.example.SharedCard.entities.TransactionEntity)t).getStatus()))
                .filter(t -> ((com.example.SharedCard.entities.TransactionEntity)t).getCreatedAt().isAfter(now.minusWeeks(1)))
                .mapToDouble(t -> ((com.example.SharedCard.entities.TransactionEntity)t).getAmount())
                .sum();

        this.monthlySpent = ((List)transactions).stream()
                .filter(t -> "APPROVED".equals(((com.example.SharedCard.entities.TransactionEntity)t).getStatus()))
                .filter(t -> ((com.example.SharedCard.entities.TransactionEntity)t).getCreatedAt().isAfter(now.minusMonths(1)))
                .mapToDouble(t -> ((com.example.SharedCard.entities.TransactionEntity)t).getAmount())
                .sum();

        this.yearlySpent = ((List)transactions).stream()
                .filter(t -> "APPROVED".equals(((com.example.SharedCard.entities.TransactionEntity)t).getStatus()))
                .filter(t -> ((com.example.SharedCard.entities.TransactionEntity)t).getCreatedAt().isAfter(now.minusYears(1)))
                .mapToDouble(t -> ((com.example.SharedCard.entities.TransactionEntity)t).getAmount())
                .sum();
    }
